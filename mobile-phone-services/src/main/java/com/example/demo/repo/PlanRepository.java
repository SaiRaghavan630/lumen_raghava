...
public interface PlanRepository extends JpaRepository<MobilePlan, Integer> {
	...
	@Query(nativeQuery=false,value="update MobilePlan set Description=:newValue where planName=:pname")
	@Modifying
	@Transactional
	int updateDescription(@Param("newValue") String updatedValidty,@Param("pname")String planName);
